...
- My team didn't have hands on knowlegde of building the systems
...
In 2014 I changed roles to support a product called Foglight - a virtual maching monitoring tool originally created by Quest Software and then was sold to Dell when later spun off their software division only to be named Quest again.
